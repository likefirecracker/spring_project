...
<form method="post" action="orderAdd" id="buyOk">
    ...
    <input type="hidden" name="book_order_number" value="">
</form>
</body>
<script>
    ...
    $(function(){
    var order_number = new Date().getTime() + Math.floor(Math.random() * 10000 + 10000);
    $("input[name=book_order_number]").attr("value",order_number);
    ...
    IMP.request_pay({
        pg : 'kakaopay',
        pay_method : 'card',
        merchant_uid : 'merchant_' + order_number,
